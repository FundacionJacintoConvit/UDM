...
delete from t_udm_parroquia;
delete from t_udm_municipio;
delete from t_udm_historico_cambio;
...
insert into t_udm_estado (id, nombre) values 
(1, 'Amazonas'),
(2, 'Anzoátegui'),
(3, 'Apure'),
(4, 'Aragua'),
...
insert into t_udm_ciudad (id, estado_id, nombre) values
(1, 1, 'Maroa'),
(2, 1, 'Puerto Ayacucho'),
...
insert into t_udm_municipio (id, estado_id, nombre) values
(1, 1, 'Alto Orinoco'),
(2, 1, 'Atabapo'),
(3, 1, 'Atures'),
(4, 1, 'Autana'),
...
insert into t_udm_parroquia (id, municipio_id, nombre) values
(1, 1, 'Alto Orinoco'),
...
insert into t_udm_tipo_antecedente (nombre, orden) values ('Hipertensión', 8);
