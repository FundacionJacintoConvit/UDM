...
drop table T_UDM_PARROQUIA;

drop table T_UDM_MUNICIPIO;

drop table T_UDM_HISTORICO_CAMBIO;
...
create sequence S_UDM_PARROQUIA
minvalue 1000
start 1000
cache 1;

create sequence S_UDM_MUNICIPIO
minvalue 1000
start 1000
cache 1;

create sequence S_UDM_HISTORICO_CAMBIO
minvalue 1000
start 1000
cache 1;
...
/*==============================================================*/
/* Table: T_UDM_HISTORICO_CAMBIO                                         */
/*==============================================================*/
create table T_UDM_HISTORICO_CAMBIO (
ID      		    SERIAL    		not null,
FECHA 				DATE        	null,
CAMPO_MODIFICADO 	VARCHAR(255)   	null,
VALOR_ANTERIOR		VARCHAR(255)	null,
VALOR_ACTUAL		VARCHAR(255)	null,
PACIENTE_ID 		INT8			not null,
USUARIO_ID 			INT8			not null,
constraint PK_UDM_HISTORICO_CAMBIO primary key (ID)
);

/*==============================================================*/
/* Table: T_UDM_PARROQUIA                                         */
/*==============================================================*/
create table T_UDM_PARROQUIA (
ID                   SERIAL not null,
NOMBRE               VARCHAR(255)         not null,
MUNICIPIO_ID            INT8                 not null,
constraint PK_UDM_PARROQUIA primary key (ID),
constraint AK_UDM_PARROQUIA unique (NOMBRE, MUNICIPIO_ID)
);

/*==============================================================*/
/* Table: T_UDM_MUNICIPIO                                         */
/*==============================================================*/
create table T_UDM_MUNICIPIO (
ID                   SERIAL not null,
NOMBRE               VARCHAR(255)         not null,
ESTADO_ID            INT8                 not null,
constraint PK_UDM_MUNICIPIO primary key (ID),
constraint AK_UDM_MUNICIPIO unique (NOMBRE, ESTADO_ID)
);
...
alter table T_UDM_HISTORICO_CAMBIO
	add constraint FK_UDM_PACIENTE_HISTORICO_CAMBIO foreign key (PACIENTE_ID)
		references T_UDM_PACIENTE (ID)
		on delete restrict on update restrict;

alter table T_UDM_HISTORICO_CAMBIO
	add constraint FK_UDM_USUARIO_HISTORICO_CAMBIO foreign key (USUARIO_ID)
		references T_UDM_USUARIO (ID)
		on delete restrict on update restrict;

alter table T_UDM_PARROQUIA
   add constraint FK_UDM_MUNICIPIO_PARROQUIA foreign key (MUNICIPIO_ID)
      references T_UDM_MUNICIPIO (ID)
      on delete restrict on update restrict;

alter table T_UDM_MUNICIPIO
   add constraint FK_UDM_ESTADO_MUNICIPIO foreign key (ESTADO_ID)
      references T_UDM_ESTADO (ID)
      on delete restrict on update restrict;

alter table T_UDM_PACIENTE
   add constraint FK_UDM_PARROQUIA_PACIENTE foreign key (PARROQUIA_ID)
      references T_UDM_PARROQUIA (ID)
      on delete restrict on update restrict;	  
...
alter table T_UDM_DIAGNOSTICO_ANTECEDENTE
   add constraint FK_UDM_DIAGNOSTICO_ANTECEDENTE1 foreign key (PACIENTE_ID)
      references T_UDM_PACIENTE (ID)
      on delete restrict on update restrict;
